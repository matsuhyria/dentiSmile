...
import { notifyAvailableSlots } from '../controllers/notificationController.js';
const { handleEndpoint, MQTT_TOPICS, subscribe } = mqttUtils;

export const initializeRoutes = async () => {
    const { SUBSCRIPTION, AVAILABILITY } = MQTT_TOPICS.NOTIFICATION;
    ...
    await subscribe(AVAILABILITY.EVENT, notifyAvailableSlots);
};